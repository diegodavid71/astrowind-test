...
import { A as AstroError, R as RenderUndefinedEntryError, a as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, k as renderUniqueStylesheet, l as renderScriptElement, n as createHeadAndContent, b as renderComponent } from './astro/server_Dr01PQfJ.mjs';
import 'kleur/colors';
import * as devalue from 'devalue';
import { A as APP_BLOG, B as BLOG_BASE, C as CATEGORY_BASE, T as TAG_BASE, d as cleanSlug, P as POST_PERMALINK_PATTERN, t as trimSlash } from './permalinks_Dm6WQjH_.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CSvHpFIY.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://grupoclever.es/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Qpez0-es.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_X7JJiqiw.mjs');
